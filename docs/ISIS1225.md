...
```
### Exámenes
- [x] #academy/202520/ISIS1225 EVA1 Son solo dos puntos ⏫ 📅 2025-09-04 ✅ 2025-09-04
	...
	- [ ] array_list
	- [ ] single_linked_lists
- [x] #academy/202520/ISIS1225 EVA2 ⏫ 📅 2025-10-09 ✅ 2025-10-09
...
- [x] #academy/202520/ISIS1225 Reto2 release ✅ 2025-09-23
- [x] #academy/202520/ISIS1225 Reto3 release 📅 2025-10-16 ✅ 2025-10-16
- [ ] #academy/202520/ISIS1225 Reto4 release 📅 2025-11-11
- [x] #academy/202520/ISIS1225 Reto1 entrega 🔼 📅 2025-09-16 ✅ 2025-09-16
- [x] #academy/202520/ISIS1225 Reto2 entrega 🔼 📅 2025-10-17 ✅ 2025-10-18
...
- [x] #academy/202520/ISIS1225 LAB5 parte 1 release 📅 2025-09-11 ✅ 2025-09-11
- [x] #academy/202520/ISIS1225 LAB5 parte 1 entrega 📅 2025-09-17 ✅ 2025-09-18

- [x] #academy/202520/ISIS1225 LAB5 parte 2 release 📅 2025-09-18 ✅ 2025-09-18
- [x] #academy/202520/ISIS1225 LAB5 parte 2 entrega 📅 2025-09-24 ✅ 2025-09-25

- [x] #academy/202520/ISIS1225 LAB6 release 📅 2025-09-26 ✅ 2025-09-26
- [x] #academy/202520/ISIS1225 LAB6 entrega 📅 2025-10-10 ✅ 2025-10-11

- [x] #academy/202520/ISIS1225 LAB7 release 📅 2025-10-16 ✅ 2025-10-16
- [x] #academy/202520/ISIS1225 LAB7 entrega 📅 2025-10-22 ✅ 2025-10-23

- [x] #academy/202520/ISIS1225 LAB8 release 📅 2025-10-23 ✅ 2025-10-23
- [x] #academy/202520/ISIS1225 LAB8 entrega 📅 2025-10-30 ✅ 2025-10-30

- [x] #academy/202520/ISIS1225 LAB9 release 📅 2025-10-30 ✅ 2025-10-30
- [ ] #academy/202520/ISIS1225 LAB9 entrega 📅 2025-11-07
...
* Review de complejidad espacial, temporal, y ==estabilidad==.
	* Memoria extra es todo lo que se cree extra pero sin incluir el espacio de la lista original y tampoco incluye el call stack de python... pues esto implicaría que todo crea espacio adicional.
...
- Busca el menor elemento en la lista
    - Intercambiándolo con elemento en la posición cero
- Busca el 2do menor elemento en la lista
    - Intercambiándolo con elemento en la posición 1
- Buscar el i-ésimo menor elemento en la lista
    - Intercambiándolo con elemento en la posición (i-1)
- Es más que un `O(n)`
- Su complejidad temporal es una serie aritmética, que se vuelve ==`O(n^2)`== (Comparaciones)
...
* El pivote puede ser el 1, -1 o el de la mitad. 
	* Hay dobles pivotes también
* Los elementos pueden estar en un posición no clara respecto al pivote
* El proceso de partición deja un pivote en su lugar.
1. Caso base
	1. Lista vacía o un solo elemento
...
```run-python
def quick_sort(arr, low = 0, high = None): # Aquí tenemos valores por defecto, esto no significa que no la podamos llamar con otro valor
	if high = None:
		high = len(arr)-1 
# quick_sort(arr) todo pasa con low=0 y el high se ajusta a len(arr)-1
# Luego con quick_sort(arr, 2, 5) ahora la función solo ordena del indice 2 al 5
# high= None es una bandera para decirle hasta donde debe ordenar
	def partition(lst, low, high):
		pivot = lst[high] # toma el último en la lista
		i = low
		for j in range(low,high):
			if lst[j]<pivot:
				lst[i], lst[j] = lst[j], lst[i]
				i+=1
		lst[i], lst[high] = lst[high], lst[i] # Esto pone el pivote en la posición correta
		return i
	if low < high:
...
* Permite ordenar ciertas partes de la función solamente
* Hace que la función sea más utilizable y autocontenida
...
>* Permite encapsular lógica específica para que solo la función que la contiene la vea.
...
>[!warning] Estabilidad
>* Note que como el pivote es random, no hay un mecanismo de protección ante el orden relativo, entonces eso quiere decir que es ==inestable==. 
...
# Pero note que aquí estamos creando una nueva lista cada vez que la cortamos
```
...
* Tabla de símbolos/Tabla de Hash o diccionarios
	* Son mecanismos abstractos que permiten almacenar grandes cantidades de información
...
* Y a diferencia de los arreglos
	* Las llaves (índices) no deben ser consecutivas o siquiera ser numéricas.
	* Las llaves deben ser comparables e inmutables
		...
		* Entonces las listas y dic no pueden ser llaves pues son mutables
			* Aunque si puede ser parte de la información
	* Las llaves no deberían ser nulas.
...
* El arreglo debe tener un tamaño razonable
	* Según la memoria
* Nosotros queremos conservar acceso O(1) a pesar de tener la llave más compleja, pero entonces con la `hash function` de esta forma podemos simplificar el problema mapeando los nombres complejos a un espacio en específico.
* Si el número de llaves es mayor a la cantidad de espacio que tenemos siempre vamos a tener colisiones y no se puede devolver.
### Propiedades de la función hash
* El proceso debe ser supremamente liviano para que sea `O(1)`.
* Deben ser una aritmética super básica para asegurar `O(1)`.
	* Eficiente en computo, porque de lo contrario todo va a ser `O(n)` o peor
* Y las debe distribuir uniformemente.
* Debe ser consistente, y de lo contrario va a ser ==completamente inútil==.
### REducción de colisiones
1. El nombre complejo se convierte en un entero, que puede ser negativo y que no tiene nada que ver con el nombre. Esto hace que sea totalmente diverso. (Función de hash)
2. Luego viene la función de compresión. Esta me entrega un indice.
	1. Esta función debe saber el tamaño del arreglo.
### `hash()` en Python
...
* Puede variar entre ejecuciones y las versiones del interprete.
	* Es valida durante la ejecución del interprete
	* No hay persistencia global
* Ahora, esto no es el indice en el array... para hacer esto vamos a aplicar la función de compresión
### Funciones de compresión
1. Método de la división
	1. Entonces en este caso debemos usar un N primo, para que no sea divisor de ningún numero dentro del hash.
2. $|x|mod(N)$ 
	1. El mod no me deja pasar del límite, pues no se pasa del rango del arreglo N.
	2. Si tenemos N=10 y sacamos x%N, estará en el rango 0 a 9. Super trivial, ¡pero funciona!
...
## W08M2
### Separate chaining
- [x] #academy/202520/ISIS1225 Hoja de trabajo de separate chaining 📅 2025-10-06 ✅ 2025-10-06
* Aparece una nueva estructura, que es un arreglo de listas, donde cada indice da acceso a un bucket (lista)
* En cada posición se apunta hacia un alista, una estructura **2D**. Cada bucket almacena 0, 1 o 2 elementos.
* La idea es que los buckets no estén densamente poblanos, así en términos de complejidad temporal no se torna `O(n)`
* EL escenario realista es que hay que evitar búsquedas secuenciales muy extensas
## W10M1

<iframe src="https://eerosales24.github.io/eda_2025_20/#/" width="100%" height="500px"></iframe>

### BST o Binary Search Tree 
* Tienen unas reglas que permiten optimizar las búsquedas de muy buena forma
* Y cuando esta balanceado entonces su altura es igual a `log2(n)` comparaciones.
	* Esto ojo **si esta balanceado**
* Un árbol balanceado mantiene su altura lo más baja posible, lo más alineada a la izquierda posible.
* Y la complejidad se va a mantener `O(log n )`, pues siempre estamos descartando del 50 al 50, luego por esto es logarítmico.
	* Esto no es un mapa, las llaves están ordenadas.
* El problema es que si el árbol es ==degenerado== entones en este escenario la complejidad va a ser `O(n)` en el peor caso.
* Ahora sale un caso bien interesante donde el arbol degenerado surge de obtener datos ordenados, well shit. Entonces hay que hacer casos muy específicos, esto es largo y complejo (150+ diapositivas).
### Árbol binario 
* El análisis de la raíz no basta para decir que el arbol esta equilibrado, tenemos que ir bajando por cada Linea hasta terminar de efectivamente decir que esta equilibrado
* El truco es que el test no es un si solo si. Y se debe continuar ==ASÍ!== con cada nodo como  una raíz
* ![[Pasted image 20251014114206.png|500]] 
* EL factor de equilibrio de calcula como
```
−1 ≤ factor de equilibrio ≤ 1 para todo nodo factor de equilibrio = altura del subárbol derecho − altura del subárbol izquierdo
```

>[!info] Árbol binario
>* Tipo ed árbol donde cada nodo 
>* Puede tener como máximo 2 hijos
>	* Uno a la izquierda 
>	* Uno a la derecha
>* Esto quiere decir que el **orden = 2**, pero el grado no es necesariamente 2.
>* El árbol que puede tener más de dos es el ==árbol n-ario==
>* Hay un distinción entre árbol perfecto y árbol no perfecto
>	* En uno todas las hojas están en el mimo tivel
>* El árbol binario completo
>	* Todos los niveles excepto el último esta lleno, pero este tiene todos lo nodos a la izquierda como le sea posible.

>[!info] Definición recursiva de un arbol
> * Esta el caso base
> 	* Un árbol vacío
...
* EL **sub-arbol**  es el arbol generado de una sección determinada del árbol.
* El **grado** es el número de hijos que tiene un nodo (El máximo)
	* El grado me lo da el nodo máximo
...
* Luego esta el número de **orden**, que es el número máximo de hijos que puede tener un nodo
![[Pasted image 20251014112420.png]]
* La **altura** es el número máximo de niveles de un árbol
![[Pasted image 20251014112344.png]]
* **Nivel** es igual a profundad
* También esta el concepto de nivel, que es cada generacíon del arbol
	* El arbol vacío no tiene 0 niveles
	* La raíz siempre está en el nivel 0
	* Los hijos de la raiz estan en nivel 1
	* Los nietos de la raíz están en el nivel 2
		* etc, etc, etc
* Un árbol vacío es aquel que no tiene ningún nodo no arista, pero sigue siendo un árbol
	* ¿Tiene un nodo raíz? como se que esta definido entonces
* Tenemos tres partes importantes, la ==raíz==, **rama** y __hoja__
	* La raíz no tiene padrea
	* La rama es un nodo que no es ni la raíz y tiene al menos un hijo
	* Las hojas son nodos sin hijos, aka el final de una rama
	* Siempre tenemos una relación de padres/hijos
		* También esta el concepto de hermano que es el que comparte un mismo padre en común dentro de la estructura.
* Empezamos con arboles binarios, un precursor de los grafos
* Los mapas nos mantienen a todo en un mismo nivel
* Un arbol es una estructura de datos jerárquica que NO ES LINEAL. A diferencia de los arreglos. Donde hay elemento superiores e inferiores.
* Los caminos son únicos dentro del arbol y nos dirigen entre los nodos pasando por las aristas.
## W11M1
Ordenamiento de arboles BST
* Recorridos en post-orden
	* La raíz queda de última
* In-orden
* Pre-orden
Idea de separación de responsabilidades
* La idea es separar una función principal y una función recursiva, de tal forma que se implemente de forma limpia
## EVA3OP
### Árboles binarios
* Mapas ordenados (Tabla de simbolos)
* Con elementos comparables
* Permiten acceder a subsets de la información
* Los árboles nos permiten hacer esto reduciendo los costes de eficiencia.
* Un árbol es una estructura jerárquica no lineal
	* Están compuestos por nodos y aristas, los nodos son aquellos que guardan la información en forma de pareja llave-valor
* Estos tienen raíces, ramas y hojas.
>[!example] ¿Qué es un árbol
...
>[!example] ¿Qué es un árbol vacío?
> árbol sin ningún nodo o arista, obviamente.
> Es la mínima expresión posible de árbol.
#### Niveles (Equivalente a profundidad) y otra terminología
...
* Grado = Número máximo de hijos que tiene uno de los nodos del árbol.

#### Árbol n-ario
* Cada nodo puede tener máximo n hijos.
#### Árbol binario lleno
...
```
### BST I
* La complejidad temporal de buscar un número en un árbol no ordenado va a tender a `O(n)` cuando este no esta ordenado. Entonces para hacer esta búsqueda efectiva tenemos que usar los Árboles binarios de búsqueda:
>[!example] Árbol binario de búsqueda
> - Cada nodo tiene una **llave única y comparable**
...
* Note que el número de comparaciones para encontrar un número va a ser aproximadamente `h+1`.
#### Balance del BST
* Este esta balanceado cuando la altura sea proporcional a `log2(n).
	* Un árbol balanceado mantiene su altura más baja
	* Esto garantiza operaciones eficientes
		* Búsqueda
		* Inserción
		* Eliminación
	* Siempre mantiene la complejidad a `O(log n)`
* Si el árbol no esta balanceado se asemeja a una estructura lineal y por lo tanto cosas como insertion se vuelven `O(n)`
#### Complejidad temporal de la búsqueda

- Mejor caso - **O(1)**

    - Si el elemento está en la raíz
- Promedio - **O(log⁡n)**
...
- Peor caso - **O(n)**
    ...
    - Árbol desbalanceado
#### Complejidad temporal de la eliminación
...
- Peor caso - **O(n)**
    ...
    - Árbol desbalanceado
### BST II - Recorridos en árboles BST
#### In-orden
...
#### Pre-orden
* Útil para copiar el árbol y obtener una expresión con parentesís
* Primero se visita nodo actual
	* Luego subárbol izquierdo
	* Luego subárbol derecho
#### Post-orden
* Útil para eliminado liberar nodos de un árbol (desde las hojas hasta la raíz)
	* El último elemento visitado es la raíz
* Primero se visita el subarbol izquierdo
	* Luego el subarbol derecho
	* Luego el nodo actual
### BST III - Implementación
* implementaciones de `floor()` y `ceiling()`
### Red-black Tree RBT
* Se estudia el Left-leaning RBT
* Que es una variante del BST
* Que se equilibra después de inserciones y eliminaciones para evitar la degradación del rendimiento
* Ideal para sistemas de bases de datos
* Es una estructura que permite acceso rápido
...
1. se debe implementar  `equals(root1, root2)`
	...
	2. la idea es identificar si efectivamente dos arboles son iguales, la implementación es muy benevolente eso si

```run-python
def equals(root1, root2):
"""
Retorna True si los árboles dados son idénticos estructuralmente y en contenido
"""
# Caso 1 Si ambos árboles están vacios, se retorna True
	if root1.is_empty() and root2.is_empty():
		return True
# Caso 2 si un árbol es vaçio y el otro no, la función debe retornar False
	if root1.is_empty() != root2.is_empty():
		return False
# Caso 3 árboles con un solo idéntico la función debe retornar True
	return root1.size_tree() == 1 and root1.size_tree() == 1 and root1["value"] == root1["value"]
# Caso 4 para árboles con un solo nodo diferente (misma llave, pero distinto valor o viceversa, la función debe retornar False)
	# creo que ya se tiene en cuenta en el caso 3
```

2. Para este punto se pide determinar si un árbol es un BST perfecto, esto quiere decir que esta lleno y que todas las hojas estén al mismo nivel.
	1. Para esto se considera una función que confirma si un arbol es árbol binario:
	2.
```run-python
...
luego por supuesto la idea entonces es implementar `is_bst(root)`, `is_full_tree(root)` y `are_leaves_at_same_depth(root)` (y técnicamente toca implementar `is_binary_tree(root)` pero esa ya nos la dan porque son muy buenos)
